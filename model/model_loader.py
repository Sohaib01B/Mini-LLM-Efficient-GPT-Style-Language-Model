...
class StoryGenerator:
    def __init__(self, model_path, device='cpu'):
        ...
        # Create tokenizer (you might need to adjust this based on your training)
    ...
    def generate_story(self, prompt, max_length=200, temperature=0.8, top_k=50):
        ...
        try:
            ...
            # Decode
            generated = self.tokenizer.decode(y[0].tolist())
            return generated
